...
CREATE TABLE `user_info`  (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
	...
	`credit_score` int(3) NULL DEFAULT 100 COMMENT '信用分',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统配置表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 383 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典数据表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2308 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单权限表' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'root', '总配置管理员', 0, '', '', '1', '', '$2a$10$YQ184iy6/ulcAszXdEVW/OqUNDF3FG0Sko0I4LPjIcFJz0E0aoPs6', '0', '0', '127.0.0.1', '2020-01-03 11:59:43', 'root', '2020-01-03 11:59:43', 'root', '2020-07-13 17:37:33', '总配置管理员', 'CNEPLT4ETF7MCWZV');
...
CREATE TABLE `user_message`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `type` int(2) NOT NULL COMMENT '类型，0:系统消息，1:个人消息',
...
DROP TABLE IF EXISTS `sys_vip_level_config`;
CREATE TABLE `sys_vip_level_config`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `level` int(2) NOT NULL COMMENT 'VIP等级',
  `start_xp` int(8) NULL DEFAULT NULL COMMENT '开始经验',
  `xp` int(8) NOT NULL COMMENT '所需经验',
  `reward_type` int(8) NOT NULL COMMENT '奖励类型',
  `reward_value` double(10, 3) NOT NULL COMMENT '奖励值',
  `enable` int(2) NOT NULL COMMENT '启用状态，0:关闭，1:启用',
  `create_user` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `create_time` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  `modified_user` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新用户',
  ...
  `remark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `IX_VIP_LEVEL_LEVEL`(`level`) USING BTREE,
  INDEX `IX_VIP_LEVEL_ENABLE`(`enable`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'VIP等级配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `assure_order`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
	...
	`type` int(2) NOT NULL COMMENT '担保类型，0:普通担保，1:多签担保',
	...
	`assure_status` int(2) NOT NULL COMMENT '担保状态，0:待加入，1:待上押，2:担保中，3:退押中，4:已退押',
...
CREATE TABLE `release_record`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
	...
	`release_status` int(2) NULL DEFAULT NULL COMMENT '解押状态，0:正常，1:已申请,等待对方同意，2:已退押',
  `final_time` bigint(20) NULL DEFAULT NULL COMMENT '结束时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `multisig_address`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
	...
	`sponsor_key` bigint(20) NULL DEFAULT NULL COMMENT '发起人密钥',
	`partner_key` bigint(20) NULL DEFAULT NULL COMMENT '参与人密钥',
  `create_time` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
