  ...
  <div class="app-container">
    <el-form ref="queryForm" :inline="true" :model="queryParams" label-width="68px">
      ...
      <el-form-item label="任务组名" prop="jobGroup">
        <el-select v-model.trim="queryParams.jobGroup" clearable placeholder="请选择任务组名">
          <el-option
      ...
      <el-form-item label="任务状态" prop="status">
        <el-select v-model.trim="queryParams.status" clearable placeholder="请选择任务状态">
          <el-option
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :formatter="jobGroupFormat" align="center" label="任务组名" prop="jobGroup"/>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="任务分组" prop="jobGroup">
              <el-select v-model.trim="form.jobGroup" placeholder="请选择">
                <el-option
                  v-for="dict in jobGroupOptions"
                  :key="dict.dictValue"
                  :label="dict.dictLabel"
          ...
          <el-col :span="12">
            <el-form-item label="是否并发" prop="concurrent">
              <el-radio-group v-model.trim="form.concurrent">
          ...
          <el-col :span="24">
            <el-form-item label="错误策略" prop="misfirePolicy">
              <el-radio-group v-model.trim="form.misfirePolicy">
