  ...
  <div class="app-container">
    <el-form :model="querydata" ref="queryForm" :inline="true">
      <el-form-item label="字典名称" prop="dictType">
        <el-select v-model.trim="querydata.dictType">
          <el-option
      ...
      <el-form-item label="字典标签" prop="dictLabel">
        <el-input
          v-model.trim="querydata.dictLabel"
          placeholder="请输入字典标签"
          clearable
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model.trim="querydata.status" placeholder="数据状态" clearable>
          <el-option
  ...
  methods: {
    ...
    getType(dictId) {
      getType(dictId).then((response) => {
        this.querydata.dictType = response.data.dictType;
    ...
    getList() {
      this.loading = true;
      listData(this.querydata).then((response) => {
    ...
    resetQuery() {
      ...
      this.querydata.dictType = this.defaultDictType;
      this.handleQuery();
    },
    /** 新增按钮操作 */
    handleAdd() {
      ...
      this.open = true;
      this.title = "添加字典数据";
      this.form.dictType = this.querydata.dictType;
    },
    // 多选框选中数据
