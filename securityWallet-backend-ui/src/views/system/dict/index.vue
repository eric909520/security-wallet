  ...
  <div class="app-container">
    ...
    <el-form :model="querydata" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="字典名称" prop="dictName">
        <el-input
          v-model.trim="querydata.dictName"
          placeholder="请输入字典名称"
          clearable
          style="width: 240px"
      ...
      <el-form-item label="字典类型" prop="dictType">
        <el-input
          v-model.trim="querydata.dictType"
          placeholder="请输入字典类型"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model.trim="querydata.status" placeholder="字典状态" clearable style="width: 240px">
          <el-option
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listType(this.addDateRange(this.querydata, this.dateRange)).then(
        (response) => {
