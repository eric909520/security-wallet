  ...
  <div class="app-container">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="querydata" ref="queryForm" :inline="true" label-width="68px">
          ...
          <el-form-item label="手机号码" prop="phonenumber">
            <el-input
              v-model.trim="querydata.phonenumber"
              placeholder="请输入手机号码"
              clearable
              style="width: 240px"
              @keyup.enter.native="handleQuery"
          ...
          <el-form-item label="状态" prop="status">
            <el-select v-model.trim="querydata.status" placeholder="用户状态" clearable style="width: 240px">
              <el-option
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listUser(this.addDateRange(this.querydata, this.dateRange)).then(
        (response) => {
