  ...
  <div class="app-container">
    ...
    <el-form :inline="true">
      <el-form-item label="菜单名称">
        <el-input
          v-model.trim="querydata.menuName"
          placeholder="请输入菜单名称"
          clearable
      ...
      <el-form-item label="状态">
        <el-select v-model.trim="querydata.visible" placeholder="菜单状态" clearable>
          <el-option
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMenu(this.querydata).then((response) => {
    ...
    /** 查询菜单下拉树结构 */
    getTreeselect() {
      treeselect({remark: '测试'}).then((response) => {
        this.menuOptions = [];
