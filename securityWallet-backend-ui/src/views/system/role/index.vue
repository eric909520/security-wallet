  ...
  <div class="app-container">
    ...
    <el-form :model="querydata" ref="queryForm" :inline="true">
      <el-form-item label="角色名称" prop="roleName">
        <el-input
          v-model.trim="querydata.roleName"
          placeholder="请输入角色名称"
          clearable
          style="width: 240px"
      ...
      <el-form-item label="权限字符" prop="roleKey">
        <el-input
          v-model.trim="querydata.roleKey"
          placeholder="请输入权限字符"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRole(this.addDateRange(this.querydata, this.dateRange)).then(
        (response) => {
    ...
    /** 查询部门树结构 */
    getDeptTreeselect() {
      deptTreeselect({remark: "备注"}).then((response) => {
